...
/* experimental 1/22/2011 */
#ifdef PML_READLINE
PMLFUNC(READLINE)
PMPROTO("READLINE(STRING)STRING")
PMLFUNC(ADD_HISTORY)
PMPROTO("ADD_HISTORY(STRING)STRING")
PMLFUNC(HISTORY_EXPAND)
PMPROTO("HISTORY_EXPAND(STRING)STRING")
#endif

/* 1/25/2011 */
#ifdef PML_RANDOM
PMLFUNC(RANDOM)
PMPROTO("RANDOM()INTEGER")

/* 12/29/2011 */
PMLFUNC(SRANDOM)
PMPROTO("SRANDOM()STRING")
PMLFUNC(SRANDOMDEV)
PMPROTO("SRANDOMDEV()STRING")
#endif
