...
MFUNC(SQLITE3_OPEN);
MFUNC(SQLITE3_CLOSE);
MFUNC(SQLITE3_ERRMSG);
MFUNC(SQLITE3_LAST_INSERT_ROWID);
MFUNC(SQLITE3_PREPARE);
MFUNC(SQLITE3_BIND_ANY);
MFUNC(SQLITE3_BIND_BLOB);
MFUNC(SQLITE3_BIND_MANY);
MFUNC(SQLITE3_BIND_PARAMETER_COUNT);
MFUNC(SQLITE3_BIND_PARAMETER_NAME);
MFUNC(SQLITE3_BIND_PARAMETER_INDEX);
MFUNC(SQLITE3_STEP);
MFUNC(SQLITE3_COLUMN_COUNT);
MFUNC(SQLITE3_COLUMN_NAME);
MFUNC(SQLITE3_COLUMN_TEXT);
MFUNC(SQLITE3_COLUMN_VALUE);
MFUNC(SQLITE3_CLEAR_BINDINGS);
MFUNC(SQLITE3_RESET);
MFUNC(SQLITE3_FINALIZE);
MFUNC(SQLITE3_EXEC);
