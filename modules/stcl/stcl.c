...
MFUNC(STCL_CREATEINTERP);
MFUNC(STCL_EVALFILE);
MFUNC(STCL_GETVAR);
MFUNC(STCL_SETVAR);
MFUNC(STCL_EVAL);
MFUNC(STCL_DELETEINTERP);
MFUNC(STCL_NEWSTRINGOBJ);
MFUNC(STCL_GETSTRINGFROMOBJ);
MFUNC(STCL_APPENDTOOBJ);
MFUNC(STCL_EVALOBJEX);
MFUNC(STCL_GETOBJRESULT);
MFUNC(STCL_OBJSETVAR2);
MFUNC(STCL_OBJGETVAR2);
MFUNC(STCL_RELEASEOBJ);
