...
OBJ=	isnobol4.obj data.obj data_init.obj main.obj syn.obj \
	...
	inet.obj execute.obj exists.obj rresvport.obj term.obj \
...
rresvport.obj : $(SRCDIR)lib\dummy\rresvport.c
...
popen.obj : $(SRCDIR)lib\win32\popen.c
	$(CC) $(CFLAGS) $(SRCDIR)lib\win32\popen.c
